...
def parser_func():
	...
	parser.add_argument('--EnableRPA', type = bool, nargs = "?", default = False, help = 'Attack type')
	parser.add_argument('--EnablePEA', type = bool, nargs = "?", default = False, help = 'Attack type')
	parser.add_argument('--EnableRandomness', type = bool, nargs = "?", default = False, help = 'Attack subtype of PETER')
